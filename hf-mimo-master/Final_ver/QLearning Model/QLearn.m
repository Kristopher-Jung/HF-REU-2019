function q = QLearn(gamma, alpha, epsilon, iterations, params, minimums, maximums)
...
for k = 1:K
    ...
    [next_state,next_reward] = Enviornment(state(state_idx),action(action_idx), params, ret); %ENV
