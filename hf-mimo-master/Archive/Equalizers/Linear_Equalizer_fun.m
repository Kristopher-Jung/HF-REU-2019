function estimated_c = Linear_Equalizer_fun(N, K, actual_isi, sigma, delta, Num_of_realizations)
% MATLAB script for Illustrative Problem 6.13. 

% %Linear Equalizer
%This is a linear equalizer, it will perform poorly under high
%amplitudal noise, but is less computationally complex

% Performs sporadically well, but worse than DFE(decision feedback equalizer) generally. This can be improved by adjusting parameters, but still not
%nearly good enough. 
